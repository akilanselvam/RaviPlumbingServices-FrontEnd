...
import HRQuoteForm from "../HumanResourceManagement/HRQuoteForm";

function WageQuotationTotalComponent({ onAddQuotation }) {
  ...
  return (
    <div className="my-8">
      <div className="non-printable">
        <div className="flex justify-end lg:pr-52 ">
          <div className="  bg-custom-green bgr w-26 rounded-lg shadow-lg p-6 mb-4  w-md">
            <label className="mr-4 block mb-2 font-semibold text-white">Number of Labours:</label>
      ...
      <table className="bg-custom-green bgr rounded-md shadow-xl mt-1 my-4 mx-auto non-printable opacity-80 overflow-hidden">
        <thead>
          <tr className="bg-gradient-to-r from-yellow-600 via-yellow-200 to-yellow-600 text-black  rounded-md">
            ...
            <th className="text-center font-semibold py-2 ">Labour Type</th>
            <th className="text-center font-semibold py-2 lg:w-24 ">Per Hour Wage</th>
            <th className="text-center font-semibold py-2 lg:w-24 ">No. of Hours</th>
            <th className="text-center font-semibold py-2 ">L.S</th>
            <th className="text-center font-semibold py-2 ">Wage</th>
          </tr>
        </thead>
        <tbody>
          {tableData.map((rowData, rowIndex) => (
            <tr key={rowIndex} className="border border-yellow-400 border-l-2 border-r-2 ">
              ...
              <td className="py-2 px-4 lg:w-3/6  ">
                <br />
                <select
                ...
                <textarea
                  ...
                  onChange={event => handleDescriptionChange(event, rowIndex)}
        ...
        <tfoot>
          <tr className="bg-gradient-to-r from-yellow-600 via-yellow-200 to-yellow-600 text-black">
            ...
            <td className="py-2  hidden lg:table-cell "></td>
            <td className="py-2  hidden lg:table-cell "></td>
            <td className="py-2 text-center  font-semibold">Total Wage:</td>
      ...
      <div className="p-4 print-only">
        <div className="mb-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold">Labour Quotation</h1>
          <button
        ...
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="text-left font-bold border py-2">Labour Role & Responsibility</th>
              <th className="text-right font-bold border py-2 w-24">Per Hour Wage</th>
              <th className="text-right font-bold border py-2 w-24">No. of Hours</th>
              <th className="text-right font-bold border py-2 ">Wage</th>
            </tr>
          </thead>
          <tbody>
            {tableData.map((rowData, rowIndex) => (
              <tr key={rowIndex}>
                ...
                <td className="py-2 w-3/6 border">
                  {rowData.name}
                  {rowData.description}
                </td>
          ...
          <tfoot>
            <tr>
              ...
              <td className="py-2"></td>
              <td className="py-2"></td>
              <td className="py-2 text-center font-bold border">Total Wage: {overallTotal.toFixed(2)}</td>
            </tr>
          </tfoot>
        </table>
      </div>
...
// Export the WageQuotationTotalComponent component
export default WageQuotationTotalComponent;
