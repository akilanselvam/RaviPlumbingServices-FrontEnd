...
function ProcessQuotationTotalComponent({ onAddQuotation }) {
      ...
      <div className="non-printable">
        <div className="flex justify-end lg:pr-52">
          <div className=" bg-custom-green bgr w-26 rounded-lg shadow-lg p-6 mb-4  w-md">
            <label className="mr-4 block mb-2 font-semibold text-white">Number of Services:</label>
      ...
      <table className="bg-custom-green bgr rounded-md mt-10 shadow-xl my-4 mx-auto non-printable opacity-80 overflow-hidden">
        <thead>
          <tr className="bg-gradient-to-r from-yellow-600 via-yellow-200 to-yellow-600 text-black  rounded-md">
            ...
            <th className="text-center font-semibold py-2 ">Service / Service Description</th>
            <th className="text-center font-semibold py-2 lg:w-24 ">Per Unit Price</th>
            <th className="text-center font-semibold py-2 lg:w-24 ">Units</th>
            ...
            <tr key={rowIndex} className="border border-yellow-400 border-l-2 border-r-2 ">
              ...
              <td className="py-2 px-4 lg:w-3/6  ">
                ...
                <select
                  ...
                  className="border border-yellow-400 px-2 py-1 w-full rounded-lg bg-orange-100 bg-opacity-40 ">
                  <option value="">Select Provided Service</option>
        ...
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="text-left font-bold border py-2">Service / Service Description</th>
              <th className="text-right font-bold border py-2 w-24">Per Unit Price</th>
              <th className="text-right font-bold border py-2 w-24">Units</th>
            ...
            {tableData.map((rowData, rowIndex) => (
              <tr key={rowIndex}>
                ...
                <td className="py-2 w-3/6 border">
                  <p className="pb-2 font-semibold">{rowData.name}</p>
                  {rowData.description}
                </td>
...
// Export the ProcessQuotationTotalComponent component
export default ProcessQuotationTotalComponent;
