...
function QuotationTable({ onAddQuotation }) {
      ...
      <div className="non-printable">
        <div className="flex justify-end lg:pr-52  ">
          <div className="  bg-custom-green bgr w-26 rounded-lg shadow-lg p-6 mb-4  w-md">
            <label className="mr-4 block mb-2 text-white font-semibold">Number of Services:</label>
      ...
      <table className="bg-custom-green bgr rounded-md shadow-xl my-4 mx-auto non-printable opacity-80 overflow-hidden">
        <thead>
          <tr className="bg-gradient-to-r from-yellow-600 via-yellow-200 to-yellow-600 text-black  rounded-md">
            ...
            <th className="text-center font-semibold py-4 px-2 ">Service / Service Description</th>
            <th className="text-center font-semibold py-4 px-2 lg:w-24 ">Per Unit Price</th>
            <th className="text-center font-semibold py-4 px-2 lg:w-24 ">Units</th>
...
// Export the QuotationTable component
