        ...
        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-3 text-lg dark:text-gray-400">
              Ne dicta praesent ocurreret has, diam theophrastus at pro. Eos etiam regione ut, persius eripuit quo id.
              Sit te euismod tacimates.
            </p>
        ...
        <div>
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              ...
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 dark:text-gray-400">
                      An per velit appellantur, ut utinam minimum nominavi sit, odio nostro habemus ne nec. Ne sonet
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 dark:text-gray-400">
                      Audire principes rationibus eam an, autem nominavi luptatum per te. Sumo fabulas vim eu, sonet
                      saperet eleifend ut vix.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
              <img
                src="https://cdn.discordapp.com/attachments/949608417759199315/1090616088728973332/IMG-20230329-WA0000.jpg"
                alt=""
                className="mx-auto rounded-lg shadow-lg dark:bg-gray-500"
              />
            </div>
